...
app.get("/203d65262f3e3b87c58f97efe2991ddb_part_1", (req, res) => {
  res.sendFile(path.resolve(__dirname, "public", "act_1", "part_1", "wiki.html"));
});
...
app.get("/e99252c5e8edbfe433ac05be478b37a1_part_2",(req,res)=>{
  res.sendFile(path.resolve(__dirname, "public", "act_1","part_2","act1_p2.html"))
})
...
app.get("/b86153090aed970056518d0cf56600d9_part_1", (req, res) => {
  res.sendFile(path.resolve(__dirname, "public", "act_3", "part_1", "act3_p1.html"));
});
...
app.get("/e02577aeed1a8105c21ca5d17a4dd883_part_2",(req,res)=>{
  res.sendFile(path.resolve(__dirname, "public", "act_3","part_2","act3_p2.html"))
})
